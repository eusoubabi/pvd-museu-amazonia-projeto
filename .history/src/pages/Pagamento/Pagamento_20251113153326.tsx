...
export const Pagamento = () => {
    ...
    // Supondo que os dados do usuário já foram preenchidos anteriormente (e-mail, nome, etc.)
    const userEmail = 'seu.email@exemplo.com'; 
    const userName = 'Nome do Cliente'; 
    ...
    const handlePaymentSubmit = (e: React.FormEvent) => {
        ...
        console.log('Dados do pagamento válidos:', { cardName, cardNumber, expiry, cvv });
